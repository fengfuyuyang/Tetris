...
void set_window() {
    ...
    // #
    // ##
    std::vector<sf::Vector2f> squareShape_L = {{firstLineX - gridSize, firstLineY},
                                             {firstLineX - gridSize, firstLineY + gridSize},
                                             {firstLineX - gridSize, firstLineY + gridSize * 2},
                                             {firstLineX , firstLineY + gridSize * 2}};
    ...
    std::mt19937 gen(rd()); // 使用 Mersenne Twister 引擎和随机种子
    ...
    Tetromino* currentTetromino = tetrominoes[random_number];
